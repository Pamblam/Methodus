...
**Version 1.0.67** | [NPM](https://www.npmjs.com/package/methodus) | [Github](https://github.com/Pamblam/Methodus)
...
| **`m.greatestCommonDivisor(1.0.67)`** | Will return the greatest common divisor of the two numbers passed to it. |
